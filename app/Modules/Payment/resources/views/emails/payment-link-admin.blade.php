...
<body style="font-family: Arial, sans-serif; color: #14213d; line-height: 1.6;">
    ...
    <p>A payment link has been generated for the following invoice:</p>
    ...
    <p style="color: #6b7280; font-size: 13px;">
        You can forward this link to the customer or use it to process the payment on their behalf.
    </p>
