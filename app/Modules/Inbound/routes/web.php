...
Route::middleware('web')->group(function (): void {
    ...
    Route::prefix('inbound/clients')->name('inbound.clients.')->group(function (): void {
        ...
        Route::middleware(['merchant.auth', 'no-cache'])->group(function (): void {
            ...
            Route::get('/{pms_client_id}/fluidpay-processors', [ClientConfigController::class, 'fluidpayProcessors'])->name('fluidpay-processors');
    ...
    Route::middleware(['merchant.auth', 'no-cache'])->group(function (): void {
        ...
        Route::post('/inbound/quickbooks/pdf-mode', [PmsIntegrationController::class, 'saveQbPdfMode'])
            ->name('inbound.quickbooks.pdf-mode');
